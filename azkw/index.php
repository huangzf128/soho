...
set_include_path(implode(PATH_SEPARATOR, array(
    //realpath(APPLICATION_PATH . '/../library'),  // for ZendFramework's library
...
$application = new Zend_Application(
    APPLICATION_ENV,
    APPLICATION_PATH . '/configs/application_az.ini'
);
...
$router->addRoute('resultUrl', 
        new Zend_Controller_Router_Route('result',	
            array('module' => 'keywordaz', 'controller'=>'keyword', 'action'=>'get-Suggest-Keyword')));

$router->addRoute('historyindex',
		new Zend_Controller_Router_Route('history/index.html',
				array('module' => 'keywordaz', 'controller'=>'keyword',
