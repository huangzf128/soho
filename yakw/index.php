...
$application = new Zend_Application(
    APPLICATION_ENV,
    APPLICATION_PATH . '/configs/application_ya.ini'
);
...
$router->addRoute('resultUrl', 
        new Zend_Controller_Router_Route('result',	
            array('module' => 'keywordya', 'controller'=>'keyword', 'action'=>'get-Suggest-Keyword')));

$router->addRoute('historyindex',
		new Zend_Controller_Router_Route('history/index.html',
				array('module' => 'keywordya', 'controller'=>'keyword',
