...
$("#historytab,#list,#wrapper,#header,#header p,#header #fav,#footer-outer-block,#main,#content,#readtex,#form,#keyword,#form #f01").css({"width":"auto"});
$("#historytab,#f01").css({"width":"100%"});
$("header,h1").remove()

$("#historytab td").eq(0).attr("width","25%");
$("#historytab td").eq(1).attr("width","55%");
$("#historytab td").eq(2).attr("width","20%");
