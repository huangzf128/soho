...
class Keywordbs_KeywordController extends Zend_Controller_Action
{
    ...
    { 
        ...
        $model = new Keywordbs_Model_SuggestKeyword(null);
    ...
    {   
        ...
        $model = new Keywordbs_Model_SuggestKeyword($keyword);
        ...
        if(!$this->accessLimitCheck() || $model->isBlockIp()){
        	...
        	$this->view->indextab = "";
        	$this->render("get-suggest-keyword-bs");
        	return ;
        }
        ...
        $this->_helper->layout->setLayout('historyd_bs');
    ...
    {
        $this->_helper->layout->setLayout('history_bs');
...
//         $this->_helper->viewRenderer->setScriptAction("get-search-history-list_bs");
		$this->render("get-search-history-list-bs");
    }
    ...
    public function getSearchHistoryDetailFileAction()
    {
        ...
        if (!$result) {
            ...
            if( $file === false ) {
                ...
                // change phtml name
                $this->_helper->viewRenderer->setRender('get-suggest-keyword-bs');
                return true;
