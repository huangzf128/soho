...
class Keywordya_KeywordController extends Zend_Controller_Action
{
    ...
    { 
        ...
        $model = new Keywordya_Model_SuggestKeyword(null);
    ...
    {   
        ...
        $model = new Keywordya_Model_SuggestKeyword($keyword);
        ...
        if(!$this->accessLimitCheck() || $model->isBlockIp()){
        	...
        	$this->render("get-suggest-keyword-ya");
        	return ;
        }
        ...
        $this->_helper->layout->setLayout('historyd_ya');
    ...
    {
        $this->_helper->layout->setLayout('history_ya');
...
//         $this->_helper->viewRenderer->setScriptAction("get-search-history-list_az");
		$this->render("get-search-history-list-ya");
    }
    ...
    public function getSearchHistoryDetailFileAction()
    {
        ...
        if (!$result) {
            ...
            if( $file === false ) {
                ...
                // change phtml name
                $this->_helper->viewRenderer->setRender('get-suggest-keyword-ya');
                return true;
