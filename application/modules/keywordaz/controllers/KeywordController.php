...
class Keywordaz_KeywordController extends Zend_Controller_Action
{
    ...
    { 
        ...
        $model = new Keywordaz_Model_SuggestKeyword(null);
    ...
    {   
        ...
        $model = new Keywordaz_Model_SuggestKeyword($keyword);
        ...
        if(!$this->accessLimitCheck() || $model->isBlockIp()){
        	...
        	$this->view->indextab = "";
        	$this->render("get-suggest-keyword-az");
        	return ;
        }
        ...
        $this->_helper->layout->setLayout('historyd_az');
    ...
    {
        $this->_helper->layout->setLayout('history_az');
...
//         $this->_helper->viewRenderer->setScriptAction("get-search-history-list_az");
		$this->render("get-search-history-list-az");
    }
    ...
    public function getSearchHistoryDetailFileAction()
    {
        ...
        if (!$result) {
            ...
            if( $file === false ) {
                ...
                // change phtml name
                $this->_helper->viewRenderer->setRender('get-suggest-keyword-az');
                return true;
