...
class Keywordaz_IndexController extends Zend_Controller_Action
{
    ...
    public function authAction()
    {
        ...
        $model = new Keywordaz_Model_User();
    ...
    * Delete
    ...
    public function displayDeleteAction(){
    	...
    	if(!empty($keyword)){
    		$model = new Keywordaz_Model_RecoveryModel($keyword);
