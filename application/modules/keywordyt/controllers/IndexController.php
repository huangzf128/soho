...
class Keywordyt_IndexController extends Zend_Controller_Action
{
    ...
    public function authAction()
    {
        ...
        $model = new Keywordyt_Model_User();
...
//             $zend_session->type = Com_Const::USER_COMMON;
    ...
    * Delete
    ...
    public function displayDeleteAction(){
    	...
    	if(!empty($keyword)){
    		$model = new Keywordyt_Model_RecoveryModel($keyword);
